...
AUTO_ROUTE_DESTINATION = "1.1.1.1"
...
def windows_default_adapter():
    ...
    try:
        ...
        index_to_luid = ip_helper.ConvertInterfaceIndexToLuid
        luid_to_alias = ip_helper.ConvertInterfaceLuidToAlias
...
class NetworkSampler:
    def __init__(
        ...
        self._counter_reader = counter_reader or (
            lambda: psutil.net_io_counters(pernic=True)
        )
        self._stats_reader = stats_reader or psutil.net_if_stats
        self._address_reader = address_reader or psutil.net_if_addrs
        self._route_resolver = route_resolver or windows_default_adapter
