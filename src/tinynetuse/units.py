...
# Formats a rate for the overlay or graph labels.
...
# Formats a rate using the auto unit rules.
...
# Converts the stored threshold before comparing it with live rates.
